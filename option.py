...
parser.add_argument('--cuhk03_labeled', action='store_true', help='if raise, use cuhk03-labeled dataset, otherwise cuhk03-detected dataset')
parser.add_argument('--video', action='store_true', default='False', help='set this option for a video dataset')
parser.add_argument('--use_masks', action='store_true', default='False', help='set this option to crop images to masks (only BayWald and Wildpark)')
...
parser.add_argument('--test_pretrained', action='store_true', default='False', help='perform a test on pretrained net before training starts')
parser.add_argument('--frame_dropping', action='store_true', default='False', help='drop some video frames in query and gallery subsets, only for BayWald/Wildpark')
parser.add_argument('--query_gallery_separation', action='store_true', default='False', help='make a gap between query and gallery frames, only for BayWald/Wildpark')
...
parser.add_argument("--if_labelsmooth", action='store_true', help='Label Smoothing Trick')
...
parser.add_argument("--h_ratio", type=float, default=0.3, help='h_ratio of batch drop block')
...
parser.add_argument('--T', type=int, default=1, help='number of iterations of computing group loss')
parser.add_argument('--num_anchors', type=int, default=2, help='number of iterations of computing group loss')
...
parser.add_argument('--warmup', type=str, default='constant', choices=['constant', 'linear'], help='warmup iteration, option: linear, constant')
...
parser.add_argument('--save', type=str, default='test', help='folder name to save')
...
# For Neptune
parser.add_argument('--nep_token', '-n', type=str, default='', help='neptune_api_token')
parser.add_argument('--nep_id', type=str, default='', help='neptune_experiment_id')
parser.add_argument('--nep_name', type=str, default='x.ji/mcmp', help='neptune_project_name')
